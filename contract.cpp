...
int main(int argc, char* argv[]) {
  ...
  /*  std::cout << "graph read start query" << std::endl;
    ...
    //double distance = bidirec_dijkstra2(g1, source_node-1, target_node-1);
   // double distance = dijkstra(g1, source_node-1, target_node-1);
    ...
    std::cout << "distance_normal: " << path_normal.second << " time query normal: " << duration_query_normal << std::endl;
    //std::pair<std::vector<int>, double> path_normal = bidirec_dijkstra2(g1, source_node-1, target_node-1);
    ...
    std::cout << "distance_ch: " << path_ch.second << " time query ch: " << duration_query_ch << std::endl;
    double path_ch = bidirec_dijkstra2(g2, source_node-1, target_node-1);
